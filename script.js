...
const STAGE_HINTS = {
  value: {
    ...
    cards: [
      {
        label: 'Light',
        good: '밝은 컬러가 잘 맞는 라이트 그룹은 색을 대는 순간 얼굴에 조명을 켠 것처럼 안색이 환해집니다. 컬러의 밝은 기운이 피부에 반사판 역할을 해 피부 결이 매끄럽고 화사하게 보이고, 잡티와 음영이 빛에 씻겨나가듯 옅어집니다. 부드러운 이목구비가 밝은 색 위에서 묻히지 않고 은은하게 살아나며, 특히 눈가와 입가의 그늘이 사라져 어려 보이는 효과가 뚜렷합니다. 얼굴과 컬러의 밝기가 같은 결로 만나기 때문에 전체 인상이 가볍고 맑아지고, 생기와 투명감이 동시에 살아납니다. 다크서클과 팔자 음영 같은 피로의 흔적이 정리되면서 컨디션이 좋아 보이고, 시선이 색이 아닌 얼굴의 중심으로 자연스럽게 모입니다. 밝은데도 들뜨지 않고 피부에 붙는 느낌이 든다면 확실히 잘 맞는 것입니다.',
        bad: '딥 그룹이 밝은 컬러를 대면 색의 밝기에 얼굴이 밀려버립니다. 컬러가 너무 환해서 상대적으로 얼굴에 그늘이 진 것처럼 어두워 보이고, 다크서클과 팔자 주름 음영이 실제보다 훨씬 짙게 부각됩니다. 뚜렷한 이목구비가 강점인데도 밝은 색이 시선을 다 가져가면서 얼굴이 흐릿하고 밋밋해 보이고, 윤곽선의 또렷함도 사라집니다. 색은 붕 떠 있고 얼굴은 가라앉아 있는 부조화가 생겨 옷이 사람을 입은 듯한 어색함이 느껴집니다. 피부톤과 컬러의 명도 차가 너무 크면 경계선이 도드라져 얼굴만 따로 분리되어 보이기도 합니다. 전체적으로 화사해지기는커녕 오히려 피곤하고 나이 들어 보이며, 얼굴의 존재감과 힘이 빠져 인상이 약해지는 것이 특징입니다.',
        // 모바일 카드 스택은 화면이 좁아 긴 문장이 부담스러우므로, 서류(데스크탑)에만
        // 위의 긴 문장을 쓰고 모바일은 이 짧은 원래 문장을 그대로 쓴다.
        shortGood: '안색이 환해지고 피부 결이 매끄러워 보이며 이목구비가 부드럽게 살아납니다.',
        shortBad: '밝기에 얼굴이 밀려 이목구비가 흐려지고, 그늘이 진 것처럼 어두워지며 다크서클과 팔자 주름 음영이 짙어집니다.',
        goodImage: 'face-light-good.png',
        badImage: 'face-light-bad.png',
      },
      {
        label: 'Deep',
        good: '어두운 컬러가 잘 맞는 딥 그룹은 색을 대는 순간 얼굴의 윤곽이 조각처럼 또렷해집니다. 어두운 색과 피부 사이에 적절한 대비가 형성되면서 얼굴선이 선명하게 정리되고, 눈썹·눈동자·입술 같은 이목구비의 존재감이 강해집니다. 피부는 어두운 배경 위에서 오히려 한 톤 밝고 깨끗해 보이는 효과가 나며, 눈빛에는 힘이 실려 카리스마 있고 세련된 인상이 만들어집니다. 얼굴이 색의 무게에 눌리지 않고 중심을 잡기 때문에 전체 분위기에 안정감과 고급스러움이 생기고, 지적이고 신뢰감 있는 무드까지 더해집니다. 올블랙 같은 강한 스타일링도 소화되어 옷이 아닌 사람이 먼저 보이며, 어두운 색을 입었는데도 칙칙함 없이 얼굴이 살아 있다면 확실하게 잘 맞는 명도입니다.',
        bad: '라이트 그룹이 어두운 컬러를 대면 색의 무게에 얼굴이 짓눌립니다. 어두운 색이 얼굴 주변의 빛을 흡수해버려 안색이 급격히 칙칙하게 가라앉고, 피부가 창백하거나 누렇게 떠 보입니다. 부드러운 이목구비가 강한 색과 대비를 이루지 못해 얼굴이 색에 잡아먹힌 듯 흐려지고, 눈가와 입가에 실제보다 깊은 그늘이 생겨 피곤하고 나이 들어 보입니다. 다크서클은 물론 얼굴의 모든 음영이 강조되어 컨디션이 나빠 보이고, 표정까지 어둡고 무거워 보이는 효과가 있습니다. 시선이 얼굴이 아닌 어두운 색 덩어리로 먼저 가기 때문에 사람의 인상이 남지 않고 옷만 기억에 남습니다. 어두운 옷을 입은 날 유독 안색이 안 좋다는 말을 듣는다면 명도가 맞지 않는다는 신호입니다.',
        shortGood: '얼굴과의 대비로 윤곽이 또렷해지고 이목구비가 부각되며 인상에 안정감이 생깁니다.',
        shortBad: '색의 무게에 눌려 안색이 칙칙하게 가라앉고, 피부가 창백하거나 노랗게 떠 피곤하고 나이 들어 보입니다.',
  ...
  chroma: {
    ...
    cards: [
      {
        label: 'Clear',
        good: '선명한 원색이 잘 맞는 클리어 그룹은 강한 색 앞에서 오히려 얼굴이 살아납니다. 원색의 쨍한 에너지에 지지 않고 피부가 맑고 화사해지며, 눈동자의 반짝임과 눈빛의 또렷함이 극대화됩니다. 색이 얼굴을 압도하는 것이 아니라 얼굴의 생기를 끌어올리는 조명 역할을 하기 때문에, 시선이 색을 지나 얼굴로 먼저 향합니다. 이목구비의 대비가 원래 뚜렷한 타입이라 강한 색과 얼굴이 균형을 이루고, 립이나 상의에 원색을 써도 색만 동동 뜨지 않고 사람 전체가 생동감 있게 보입니다. 인상은 자신감 있고 에너지 넘치게 표현되며, 흐린 색을 입었을 때보다 원색을 입었을 때 오히려 어려 보이고 건강해 보입니다. 원색 앞에서 얼굴이 이기는 이 반응이 클리어 타입의 확실한 증거입니다.',
        bad: '소프트 그룹이 선명한 원색을 대면 색이 얼굴을 완전히 압도해버립니다. 시선이 온통 색으로만 쏠려 얼굴은 배경처럼 밀려나고, 부드러운 이목구비가 강한 색의 기세에 눌려 평면적이고 밋밋해 보입니다. 원색의 쨍한 기운과 피부가 부딪히면서 잡티·다크서클·붉은기 같은 결점이 실제보다 도드라지고, 안색은 상대적으로 칙칙하고 지쳐 보입니다. 색과 사람이 따로 노는 부조화 때문에 아무리 비싸고 예쁜 옷이라도 옷만 기억에 남고 사람의 인상은 남지 않습니다. 얼굴의 자연스러운 분위기와 부드러운 매력이 강한 색에 가려져 오히려 인상이 없어 보이는 역효과가 나며, 선명한 색을 입은 날 유독 얼굴이 죽는다는 느낌을 받는다면 채도가 맞지 않는다는 확실한 신호입니다.',
        shortGood: '얼굴이 색에 지지 않고 생기가 돌며 눈동자와 눈빛이 또렷해지고, 얼굴이 색보다 먼저 시선을 끕니다.',
        shortBad: '색이 얼굴을 압도해 시선이 색으로만 가고, 얼굴이 밋밋해지며 잡티와 다크서클이 도드라져 보입니다.',
        goodImage: 'face-clear-good.png',
        badImage: 'face-clear-bad.png',
      },
      {
        label: 'Soft',
        good: '뮤트톤이 잘 맞는 소프트 그룹은 회색빛이 섞인 부드러운 색을 대는 순간 얼굴과 색이 하나로 스며듭니다. 색이 피부 위에 얹히는 것이 아니라 피부의 연장선처럼 자연스럽게 어우러져 결이 곱고 부드러워 보이고, 은은한 혈색이 살아납니다. 이목구비의 대비가 부드러운 타입이라 색의 차분함과 얼굴의 분위기가 같은 결로 만나 조화롭고 편안한 인상이 완성되며, 꾸미지 않은 듯한 세련됨과 고급스러운 무드가 생깁니다. 톤온톤으로 겹쳐 입어도 밋밋하지 않고 깊이가 느껴지고, 메이크업도 뮤트 계열로 맞추면 화장이 피부에 녹아든 것처럼 자연스럽습니다. 화려하지 않은데도 오래 볼수록 분위기 있다는 인상을 주는 것, 그것이 뮤트톤이 잘 맞는 사람의 특징입니다.',
        bad: '클리어 그룹이 뮤트톤을 대면 색의 탁한 기운이 얼굴까지 흐려버립니다. 회색빛 섞인 색이 피부의 맑은 생기를 덮어 안색이 칙칙하게 가라앉고, 반짝이던 눈빛과 눈동자의 또렷함이 힘을 잃습니다. 원래 또렷한 이목구비와 흐린 색이 어긋나면서 얼굴 전체가 흐릿하고 졸려 보이는 인상이 되고, 아프거나 피곤한 사람처럼 보이기도 합니다. 뮤트톤 특유의 차분함이 이 타입에게는 세련됨이 아니라 밋밋함과 생기 없음으로 표현되어, 존재감과 화사함이라는 최대 강점이 사라집니다. 얼굴과 색이 함께 가라앉기 때문에 전체 분위기가 처져 보이고, 흐린 색을 입은 날 유독 안색이 안 좋아 보인다거나 인상이 흐려 보인다는 말을 듣는다면 채도가 맞지 않는다는 신호입니다.',
        shortGood: '얼굴과 색이 자연스럽게 어우러져 편안하고 고급스러운 인상이 됩니다.',
        shortBad: '얼굴까지 같이 탁해져 흐릿하고 생기 없이, 피곤하거나 아파 보입니다.',
  ...
  tone: {
    ...
    cards: [
      {
        label: 'Warm',
        good: '웜 컬러가 잘 맞는 사람은 색을 대는 순간 피부 속에서 혈색이 배어나오는 것처럼 안색이 살아납니다. 피부의 노란빛이 칙칙함이 아니라 건강한 생기로 표현되면서 얼굴 전체가 화사하고 따뜻한 인상으로 바뀝니다. 다크서클이 브라운톤으로 자연스럽게 묻혀 눈가가 환해 보이고, 피부 결이 한 톤 정돈된 것처럼 매끄럽게 보입니다. 볼에는 은은한 복숭아빛 혈색이 도는 것처럼 보여 화장을 하지 않아도 생기 있는 얼굴이 되고, 입술색도 자연스럽게 살아납니다. 컬러와 피부가 서로 밀어내지 않고 하나의 톤으로 어우러지기 때문에 이질감이 없으며, 시선이 색이 아닌 얼굴로 먼저 향합니다. 이목구비의 입체감도 부드럽게 살아나 전체적으로 편안하면서도 밝은 에너지가 느껴지는 인상이 완성됩니다.',
        bad: '쿨톤인 사람이 웜 컬러를 대면 피부와 색이 충돌하면서 안색이 급격히 무너집니다. 컬러의 노란 기운이 피부에 반사되어 얼굴이 전체적으로 누렇게 뜨고, 원래 없던 황달기가 생긴 것처럼 탁하고 병약해 보입니다. 피부의 붉은기와 홍조는 오히려 더 도드라져 얼굴이 얼룩덜룩해 보이고, 색소침착과 잡티도 짙어 보입니다. 눈흰자와 치아가 상대적으로 누렇게 보여 인상이 흐려지고, 눈빛의 또렷함도 사라집니다. 피부와 컬러가 겉돌기 때문에 아무리 좋은 옷이나 화장품이라도 남의 것을 빌려 쓴 듯한 이질감이 생기며, 같은 사람인데도 몇 살은 더 나이 들어 보이거나 밤을 새운 것처럼 피곤해 보이는 효과가 나타납니다. 얼굴보다 색이 먼저 눈에 들어오는 것도 안 맞는다는 신호입니다.',
        shortGood: '피부에 노란빛 혈색이 자연스럽게 돌아 생기 있어 보이고, 다크서클이 브라운톤으로 묻히며, 피부 결도 매끈하게 정돈됩니다.',
        shortBad: '피부가 누렇게 뜨고 안색이 탁해지며, 치아까지 상대적으로 누레 보입니다.',
        goodImage: 'face-warm-good.png',
        badImage: 'face-warm-bad.png',
      },
      {
        label: 'Cool',
        good: '쿨 컬러가 잘 맞는 사람은 색을 대는 순간 피부가 맑고 투명해집니다. 컬러의 푸른 기운이 피부의 붉은기와 잡티를 중화시켜 결이 매끄럽고 깨끗하게 정돈되어 보이고, 얼굴 전체에 흰 도화지 같은 투명감이 생깁니다. 눈흰자와 치아가 더 하얗게 보여 인상이 또렷하고 청초해지며, 눈동자와 피부의 대비가 살아나 눈빛이 반짝입니다. 다크서클의 푸르스름한 기운도 컬러와 어우러져 오히려 옅어 보이는 효과가 있습니다. 피부와 색이 같은 온도로 만나기 때문에 세련되고 도회적인 분위기가 자연스럽게 형성되고, 립이나 블러셔 같은 포인트 컬러도 겉돌지 않고 피부에 스며들 듯 발색됩니다. 전체적으로 차분하면서도 맑은 에너지가 느껴지는, 깨끗하고 정돈된 인상이 완성됩니다.',
        bad: '웜톤인 사람이 쿨 컬러를 대면 얼굴에서 혈색이 빠져나간 것처럼 창백하고 파리해 보입니다. 피부의 노란빛과 컬러의 푸른빛이 부딪히면서 안색이 회색빛으로 가라앉고, 건강한 생기 대신 아프고 지쳐 보이는 인상이 만들어집니다. 입술 주변과 눈가에 푸르스름한 그늘이 도드라져 다크서클이 실제보다 훨씬 짙어 보이고, 팔자 주름 같은 음영도 강조됩니다. 피부 결의 미세한 요철과 모공이 부각되어 결이 거칠어 보이는 효과도 나타납니다. 얼굴의 따뜻한 기운과 색의 차가운 기운이 계속 어긋나기 때문에 화장이 들뜬 것 같은 부자연스러움이 생기고, 아무리 선명한 컬러라도 얼굴을 살리지 못한 채 색만 동동 떠 보입니다. 표정까지 어두워 보여 전체적인 인상이 무겁게 내려앉습니다.',
        shortGood: '피부가 맑고 투명해지며 붉은기와 잡티가 중화되고, 눈흰자와 치아가 더 하얘 보입니다.',
        shortBad: '혈색이 빠진 듯 창백해지고 입술 주변이 푸르스름해지며, 다크서클과 붉은 반점이 오히려 도드라집니다.',
...
stageHintHeading.className = 'tutorial-heading stage-hint-heading';
const stageHintBody = document.createElement('p');
stageHintBody.className = 'tutorial-body stage-hint-body';
...
function buildHintDocument(cards) {
  ...
  // 종이 질감(텍스처)은 맨 앞(0번, active)에만 CSS에서 입히고, 뒤에 깔린
  // 갈피들은 이 색만 평평하게 쓴다.
  ...
  function renderPage() {
    ...
    tabEls.forEach((tab, i) => {
      ...
      // 앞(0번, active)은 CSS에서 종이 질감까지 덧입히고, 뒤에 깔린
      // 갈피들은 이 색만 평평하게 쓴다.
...
function buildMobileCardStack(cards) {
  const faces = [];
  cards.forEach((card) => {
    // 모바일은 화면이 좁아 서류(데스크탑)용 긴 문장 대신, 원래 쓰던 짧은
    // 문장(shortGood/shortBad)을 그대로 보여준다.
    faces.push({ label: card.label, state: 'good', text: card.shortGood || card.good, image: card.goodImage || HINT_FACE_PLACEHOLDER });
    faces.push({ label: card.label, state: 'bad', text: card.shortBad || card.bad, image: card.badImage || HINT_FACE_PLACEHOLDER });
  });
...
paymentBackButton.style.color = '#000000';
